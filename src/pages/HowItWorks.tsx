      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-12">
        ...
        <div>
          <div className="flex items-center gap-2 text-xs text-gray-500 mb-4">
            ...
            <span>›</span>
            <span className="text-gray-800 font-semibold">{t("हमारा दृष्टिकोण एवं प्रणाली अवलोकन", "Our Approach & System Summary")}</span>
          </div>

          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 sm:p-8">
            <div className="inline-flex items-center gap-2 text-xs font-bold px-3 py-1 rounded bg-indigo-50 text-indigo-800 mb-3 border border-indigo-200">
            ...
            <p className="text-base text-gray-600 mt-3 leading-relaxed max-w-4xl">
              {t(
        ...
        <section className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 sm:p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mt-6">
            <div className="bg-red-50 border border-red-200 rounded-xl p-5">
              ...
              <h3 className="font-bold text-red-900 mb-1.5">{t("1. पिंग-पॉन्ग रूटिंग", "1. Ping-Pong Routing")}</h3>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-5">
              <div className="text-2xl mb-2">📄</div>
              <h3 className="font-bold text-amber-900 mb-1.5">{t("2. कागजी खानापूर्ति", "2. Paper Compliance")}</h3>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5">
              <div className="text-2xl mb-2">👤</div>
              <h3 className="font-bold text-blue-900 mb-1.5">{t("3. अदृश्य जवाबदेही", "3. Anonymous Inaction")}</h3>
            ...
            <table className="w-full border-collapse text-left">
              <thead>
                <tr className="border-b border-gray-200">
                  <th className="p-4 bg-gray-50 text-gray-800 text-xs font-bold uppercase">{t("पहलू", "Aspect")}</th>
                  <th className="p-4 bg-red-50 text-red-800 text-xs font-bold uppercase border-l border-r border-red-100">❌ {t("पुराना CPGRAMS", "Old CPGRAMS")}</th>
                  <th className="p-4 bg-emerald-50 text-emerald-800 text-xs font-bold uppercase">✅ {t("CPGRAMS AI", "CPGRAMS AI")}</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100">
                {compareRows.map((row, i) => (
                  <tr key={i} className={i % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                    <td className="p-4 text-xs font-bold text-gray-800">{row.aspect}</td>
                    <td className="p-4 text-xs text-red-700 border-l border-r border-red-50">{row.old}</td>
                    <td className="p-4 text-xs text-emerald-700 font-semibold">{row.new}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 sm:p-8">
          ...
          <div className="p-5 rounded-xl border border-gray-200 bg-gray-50 font-mono text-xs text-gray-800 leading-relaxed overflow-x-auto mb-6">
            <div className="text-indigo-600 font-bold mb-2">⚡ VOICE-TO-ROUTED-COMPLAINT FLOW:</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 rounded-xl border border-blue-200 bg-blue-50">
              <h3 className="font-bold text-sm text-blue-900 mb-2">📱 {t("नागरिक इंटरफ़ेस (Client Side)", "Citizen Interface (Client Side)")}</h3>
            ...
            <div className="p-4 rounded-xl border border-green-200 bg-green-50">
              <h3 className="font-bold text-sm text-green-900 mb-2">🏛️ {t("अधिकारी डैशबोर्ड (Officer View)", "Officer Dashboard (Backend View)")}</h3>
        ...
        <section className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 sm:p-8">
          ...
          <div className="space-y-4 text-xs sm:text-sm text-gray-700">
            <div className="p-4 rounded-xl border border-gray-200 bg-gray-50">
              <strong className="text-indigo-700">{t("माह 1 — स्मार्ट रूटिंग:", "Month 1 — Smart Routing:")}</strong>{" "}
            ...
            <div className="p-4 rounded-xl border border-gray-200 bg-gray-50">
              <strong className="text-indigo-700">{t("माह 2 — गुणवत्ता मॉनिटर:", "Month 2 — Quality Monitor:")}</strong>{" "}
            ...
            <div className="p-4 rounded-xl border border-gray-200 bg-gray-50">
              <strong className="text-indigo-700">{t("माह 3 — सार्वजनिक जवाबदेही:", "Month 3 — Public Accountability:")}</strong>{" "}
            ...
            <div className="p-4 rounded-xl border border-gray-200 bg-gray-50">
              <strong className="text-indigo-700">{t("माह 4 — व्यवस्थागत समाधान:", "Month 4 — Systemic Fixes:")}</strong>{" "}
        ...
        <div className="flex flex-col sm:flex-row gap-4 pt-4">
          ...
          <Link
            to="/accountability"
            className="flex-1 py-4 px-6 rounded-xl font-bold text-center text-gray-800 bg-gray-100 hover:bg-gray-200 border border-gray-200 text-base transition-all"
          >
