    ...
    <div className="min-h-screen py-10" style={{ background: "var(--background)" }} id="main-content">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex items-center gap-2 text-xs text-gray-500 mb-4">
          ...
          <span>›</span>
          <span className="text-gray-800 font-semibold">{t("वेब सूचना प्रबंधक", "Web Information Manager")}</span>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
          ...
          <div className="p-6 sm:p-8 space-y-6">
            ...
            <div className="border border-gray-200 rounded-xl p-6 bg-gray-50">
              <div className="flex items-start gap-4 flex-col sm:flex-row">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-sm font-semibold text-[#1a237e]">
                    ...
                    <div className="bg-white p-3 rounded-lg border border-gray-200">
                      ...
                      <div className="mt-1 space-y-1">
                        <div className="font-medium text-gray-800">
                          📞 Telephone: <a href="tel:01123401455" className="text-[#1a237e] font-mono font-bold">011-23401455</a>
                        </div>
                        <div className="font-medium text-gray-800">
                          📧 Email: <a href="mailto:director-pg@darpg.gov.in" className="text-[#1a237e] font-mono font-bold">director-pg@darpg.gov.in</a>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="p-4 rounded-lg bg-blue-50 border border-blue-200 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
              <div>
