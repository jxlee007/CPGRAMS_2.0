      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sm:p-8 mb-6">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-xs font-bold px-2.5 py-1 rounded bg-green-50 text-green-800 border border-green-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-6 bg-white rounded-xl border border-gray-200 shadow-sm p-6 sm:p-8">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-bold text-gray-900 flex items-center gap-2">
                <span>🔐</span>
                <span>{t("सुरक्षित खाता पंजीकरण फॉर्म", "Secure Citizen Registration")}</span>
              </h2>
              <span className="text-[10px] text-green-700 bg-green-50 border border-green-200 px-2 py-0.5 rounded font-mono">
                PoW Protected
              </span>
            </div>
            ...
            <form onSubmit={handleFormSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2.5 text-sm rounded border border-gray-300 bg-gray-50 text-gray-900 outline-none focus:border-[#1a237e]"
                  required
              ...
              <div className="border border-gray-200 rounded-lg p-4 bg-gray-50 space-y-3">
                <div className="flex items-center justify-between text-xs">
                  ...
                  <button
                    ...
                    className="text-[11px] text-[#1a237e] hover:underline font-semibold"
                  >
                    🔄 {t("पुनः चलाएं", "Re-run")}
                  </button>
                </div>
            ...
            {verificationResult === "success" && (
              <div className="mt-4 p-3 rounded-lg bg-green-50 border border-green-300 text-green-800 text-xs font-semibold text-center flex items-center justify-center gap-1.5">
                <span>🛡️</span>
            ...
            {verificationResult === "error" && (
              <div className="mt-4 p-3 rounded-lg bg-red-50 border border-red-300 text-red-800 text-xs font-semibold text-center">
