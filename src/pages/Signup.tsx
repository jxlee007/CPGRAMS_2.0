      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6">
        {step === "details" && (
          <form onSubmit={handleSubmitDetails}>
            ...
            <div className="border border-gray-200 rounded-lg p-3 bg-gray-50 flex items-center justify-between gap-3 text-xs">
              <div className="flex items-center gap-2.5">
                <span className="text-green-600 font-bold text-base">✓</span>
                <div>
                  <div className="font-bold text-gray-800 flex items-center gap-1.5">
                    <span>{t("क्रिप्टोग्राफिक सुरक्षा (PoW CAPTCHA)", "Cryptographic Proof-of-Work Verified")}</span>
                    <span className="text-[10px] px-1.5 py-0.2 rounded bg-green-100 text-green-800 font-mono">ALTCHA</span>
                  </div>
              ...
              <Link to="/pow-demo" className="text-[#1a237e] font-semibold hover:underline flex-shrink-0 text-[11px]">
