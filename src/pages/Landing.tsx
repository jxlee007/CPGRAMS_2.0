...
const TICKER_MESSAGES = [
  "🔬 HACKATHON POC — All data is simulated. Not an official government portal. Built to demonstrate AI-powered grievance rethink.",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-14 sm:py-20">
          <div className="flex flex-col lg:flex-row items-center gap-10">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              >
                🔬 {t("हैकथॉन POC · DARPG · CPGRAMS · AI-शोध", "Hackathon POC · DARPG · CPGRAMS · AI Research")}
              </div>
            ...
            <div className="flex-shrink-0 w-full max-w-sm">
              <div className="bg-white rounded text-gray-900 shadow-2xl overflow-hidden">
                <div className="px-4 py-3 flex items-center gap-2" style={{ background: "#1a237e" }}>
                  ...
                  <span className="text-xs text-blue-200 ml-2 font-mono">CPGRAMS AI · Prototype Routing Demo</span>
                </div>
                <div className="p-4">
            ...
            <Link to="/accountability" className="action-tile" style={{ borderTopColor: "#880e4f" }}>
              ...
              <div>
                <div className="font-bold text-gray-900 text-base flex items-center justify-center gap-1">
                  ...
                  <span className="text-[10px] bg-amber-100 text-amber-800 font-bold px-1.5 py-0.5 rounded">MOCK</span>
                </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-px bg-gray-200">
            {stats.map((s) => (
              <div key={s.label} className="bg-white text-center py-6 px-4">
                ...
                <div className="text-xs text-gray-600 leading-snug">{s.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-12 bg-white border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-600 mt-1">{t("पुराना बनाम नया — AI का प्रभाव", "Old vs New — The AI difference")}</p>
          </div>
