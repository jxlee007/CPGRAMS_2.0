    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
          ...
          <div className="border border-blue-200 bg-blue-50/60 rounded-2xl p-5 shadow-xs">
            ...
            <div className="text-[11px] text-blue-700 mt-3 pt-2 border-t border-blue-200/60 flex items-center justify-between">
          ...
          <div className="border border-emerald-200 bg-emerald-50/60 rounded-2xl p-5 shadow-xs">
            <div className="flex items-center justify-between mb-2">
            ...
            <div className="text-[11px] text-emerald-700 mt-3 pt-2 border-t border-emerald-200/60 flex items-center justify-between">
