...
export default function Navbar() {
  ...
  return (
    <header>
      {/* ── POC PROTOTYPE BANNER ── */}
      <div
        role="banner"
        aria-label="Prototype Notice"
        style={{ background: "#b45309", borderBottom: "1px solid #92400e" }}
        className="text-white py-1.5 px-4 text-center text-[11px] sm:text-xs font-medium"
      >
        <span className="inline-flex items-center gap-2 flex-wrap justify-center">
          <span className="bg-white/20 text-white font-black text-[10px] px-2 py-0.5 rounded uppercase tracking-widest border border-white/30">POC</span>
          <span>
            {t(
              "यह एक शोध प्रोटोटाइप है — मॉक डेटा के साथ। किसी भी वास्तविक सरकारी प्रणाली से नहीं जुड़ा।",
              "Research Prototype — Mock Data Only. Not affiliated with or endorsed by any government body."
            )}
          </span>
